...
# --- Garbage Cleaning
execute 'cleanup_old_downloads' do
  command 'sudo rm -rf apache-tomcat*.*'
  cwd '/tmp'
end

remote_file '/tmp/apache-tomcat-8.5.32.tar.gz' do
  source 'http://archive.apache.org/dist/tomcat/tomcat-8/v8.5.32/bin/apache-tomcat-8.5.32.tar.gz'
end
